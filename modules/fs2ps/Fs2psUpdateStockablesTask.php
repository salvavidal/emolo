...
class Fs2psUpdateStockablesTask extends Fs2psUpdaterTask
{
	
	public function __construct($mng, $cmd)
	{
		parent::__construct('update_stockables', $mng, $cmd);
		$this->addUpdater('price_rates', 'Fs2psGroupUpdater');
		$this->addUpdater('products', 'Fs2psStockablesUpdater');
		$this->addUpdater('combinations', 'Fs2psStockablesCombisUpdater');
	}
