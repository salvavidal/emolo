...
class Fs2psDownloadOrdersTask extends Fs2psExtractorTask
{
	public function __construct($mng, $cmd)
	{
		parent::__construct('download_orders', $mng, $cmd);
		$this->addExtractor('orders', 'Fs2psOrderExtractor');
		$this->addExtractor('order_lines', 'Fs2psOrderLineExtractor');
	}
}
