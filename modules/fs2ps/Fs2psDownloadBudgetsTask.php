...
class Fs2psDownloadBudgetsTask extends Fs2psExtractorTask
{
    public function __construct($mng, $cmd)
    {
        parent::__construct('download_budgets', $mng, $cmd);
        $this->addExtractor('budgets', 'Fs2psOrderExtractor');
        $this->addExtractor('budget_lines', 'Fs2psOrderLineExtractor');
    }
}
