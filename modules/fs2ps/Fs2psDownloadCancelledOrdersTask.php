...
class Fs2psDownloadCancelledOrdersTask extends Fs2psExtractorTask
{
    public function __construct($mng, $cmd)
    {
        parent::__construct('download_cancelled_orders', $mng, $cmd);
        $this->addExtractor('cancelled_orders', 'Fs2psOrderExtractor');
        $this->addExtractor('cancelled_order_lines', 'Fs2psOrderLineExtractor');
    }
}
