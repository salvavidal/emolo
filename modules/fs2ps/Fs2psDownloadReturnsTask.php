...
class Fs2psDownloadReturnsTask extends Fs2psExtractorTask
{
    public function __construct($mng, $cmd)
    {
        parent::__construct('download_returns', $mng, $cmd);
        $this->addExtractor('returns', 'Fs2psReturnExtractor');
        $this->addExtractor('return_lines', 'Fs2psReturnLineExtractor');
    }
}
