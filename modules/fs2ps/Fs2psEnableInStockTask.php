...
class Fs2psEnableInStockTask extends Fs2psTask
{

	public function __construct($mng, $cmd)
	{
		parent::__construct('enable_in_stock', $mng, $cmd);
	}

	protected function _execute($cmd)
	{
		// Activamos productos inactivos con stock siendo el stock la suma del stock de las combinaciones si el producto tiene combinaciones
		Fs2psTools::dbExec(
			'
			UPDATE @DB_product p
			...
			inner join (
				...
				from (
					...
					where p.active = 0 and p.state>0
