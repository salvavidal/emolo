...
class Fs2psDownloadCustomersTask extends Fs2psExtractorTask
{
	public function __construct($mng, $cmd)
	{
		parent::__construct('download_customers', $mng, $cmd);
		
		$cfg = $this->cfg;
		$this->addExtractor('customers', 'Fs2psCustomerExtractor');
		if ($cfg->get('DOWNLOAD_CUSTOMER_ADDRESSES', false)) $this->addExtractor('customer_addresses', 'Fs2psCustomerAddressExtractor');
	}
}
