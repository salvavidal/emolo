...
class Fs2psUpdateOrdersTask extends Fs2psUpdaterTask
{
	
	public function __construct($mng, $cmd)
	{
		parent::__construct('update_orders', $mng, $cmd);
		$this->addUpdater('orders', 'Fs2psUpdateOrderUpdater');
		$this->addUpdater('orders_downloaded', 'Fs2psUpdateOrderUpdater');
		$this->addUpdater('orders_returned', 'Fs2psUpdateOrderUpdater');
		$this->addUpdater('orders_sent', 'Fs2psUpdateOrderUpdater');
		$this->addUpdater('orders_invoiced', 'Fs2psUpdateOrderUpdater');
		$this->addUpdater('orders_sent_track', 'Fs2psUpdateOrderTrack');
		$this->addUpdater('orders_invoiced_track', 'Fs2psUpdateOrderTrack');
	}
