...
class Fs2psUpdateCatalogCriticalTask extends Fs2psUpdaterTask
{
	
	public function __construct($mng, $cmd)
	{
		parent::__construct('update_catalog_critical', $mng, $cmd);
		$this->addUpdater('products', 'Fs2psProductCriticalUpdater');
		$this->addUpdater('combinations', 'Fs2psSizeColourCombinationCriticalUpdater');
	}
