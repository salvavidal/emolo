...
class Fs2psDownloadProductsStockTask extends Fs2psExtractorTask
{
	public function __construct($mng, $cmd)
	{
		parent::__construct('download_products', $mng, $cmd);
	}
	
	public function preExecute()
	{
	    $this->addExtractor('products', 'Fs2psProductStockExtractor');
	}
}
