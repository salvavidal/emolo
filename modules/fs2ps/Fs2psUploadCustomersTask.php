...
class Fs2psUploadCustomersTask extends Fs2psUpdaterTask
{
	
	public function __construct($mng, $cmd)
	{
		parent::__construct('upload_customers', $mng, $cmd);
		
		$this->addUpdater('price_rates', 'Fs2psGroupUpdater');
		$this->addUpdater('customers', 'Fs2psCustomerUpdater');
		$this->addUpdater('customer_addresses', 'Fs2psAddressUpdater');
