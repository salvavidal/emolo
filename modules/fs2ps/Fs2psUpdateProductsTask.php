...
class Fs2psUpdateProductsTask extends Fs2psUpdaterTask
{
	
	public function __construct($mng, $cmd)
	{
		parent::__construct('update_products', $mng, $cmd);
		$this->addUpdater('products', 'Fs2psUpdateProductUpdater');
		$this->addUpdater('combinations', 'Fs2psUpdateSizeColourCombinationUpdater');
	}
